    ...
    <div class="span2">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li <?php echo(((strpos($_SERVER['PHP_SELF'], 'editgroup.php'))||(strpos($_SERVER['PHP_SELF'], 'newusers.php')))? 'class="active"':null) ?>><a href="newusers.php"><i class="icon-inbox"></i> Approve Members</a></li>
          <?php endif; ?>
        </ul>
      </div><!--/.well -->
    </div><!--/span-->
